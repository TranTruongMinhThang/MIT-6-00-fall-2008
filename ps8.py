...
def loadSubjects(filename):
    ...
    for line in inputFile:
        mapping_subject[line.split(",")[0]] = tuple([int(i) for i in line.strip().split(",")[1:]])
    return mapping_subject

    # TODO: Instead of printing each line, modify the above to parse the name,
    # value, and work of each subject and create a dictionary mapping the name
    # to the (value, work).

smallCatalog = loadSubjects(SUBJECT_FILENAME)
print(smallCatalog)
...
def countAdvisor (smallCatalog, maxWork):
    ...
    if maxWork > 0:
        for i in subName:
                ...
                count += a
    return count
# print(countAdvisor(smallCatalog,8))
